...
```groovy
implementation "com.easypost:easypost-api-client:6.5.0"
```
...
Library documentation can be found on the web at: <https://easypost.github.io/easypost-java/> or locally in the `docs` directory.
