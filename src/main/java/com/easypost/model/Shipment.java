...
public final class Shipment extends EasyPostResource {
     ...
     * @throws EasyPostException
     */
    public List<Rate> getSmartrates(final String apiKey)
            throws EasyPostException {
     ...
     * @throws EasyPostException
     */
    public Shipment buy(final Map<String, Object> params)
            throws EasyPostException {
     ...
     * @throws EasyPostException
     */
    public Shipment label(final Map<String, Object> params)
            throws EasyPostException {
     ...
     * @throws EasyPostException
     */
    public Rate lowestRate(final List<String> carriers)
            throws EasyPostException {
