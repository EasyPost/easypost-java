...
public class ScanForm extends EasyPostResource {
     ...
     */
    public static ScanForm create(Map<String, Object> params)
            throws EasyPostException {
     ...
     * @throws EasyPostException
     */
    public static ScanForm create(Map<String, Object> params, String apiKey)
            throws EasyPostException {
     ...
     * @throws EasyPostException
     */
    public static ScanForm retrieve(String id, String apiKey)
            throws EasyPostException {
     ...
     * @throws EasyPostException
     */
    public static ScanFormCollection all(Map<String, Object> params)
            throws EasyPostException {
